...
Source0  : https://files.pythonhosted.org/packages/d9/18/8215e8c2d16148c2c9b04e7329bdb43ae33819cdd1f73a79cd6e264bad4f/reportlab-3.6.6.tar.gz
...
%prep
%setup -q -n reportlab-3.6.6
cd %{_builddir}/reportlab-3.6.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643127284
...
cp %{_builddir}/reportlab-3.6.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.6.6/src/reportlab/fonts/bitstream-vera-license.txt %{buildroot}/usr/share/package-licenses/pypi-reportlab/b3245f6ac784e19a10843831b45b5944c62e3ccc
cp %{_builddir}/reportlab-3.6.6/src/reportlab/license.txt %{buildroot}/usr/share/package-licenses/pypi-reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.6.6/src/rl_addons/renderPM/libart_lgpl/COPYING %{buildroot}/usr/share/package-licenses/pypi-reportlab/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
