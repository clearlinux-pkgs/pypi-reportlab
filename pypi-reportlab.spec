...
Source0  : https://files.pythonhosted.org/packages/d8/cf/efb86961f9aed4f95556a15034ee66b1315de6752290c33634120ff4fcd1/reportlab-4.0.7.tar.gz
...
%prep
%setup -q -n reportlab-4.0.7
cd %{_builddir}/reportlab-4.0.7
pushd ..
cp -a reportlab-4.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699460307
