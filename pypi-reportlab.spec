...
Version  : 4.2.2
Release  : 110
URL      : https://files.pythonhosted.org/packages/72/e0/c88e58d38702cff7031dd47c9cdebb8503da5c9887470c2d5407a48dd507/reportlab-4.2.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/72/e0/c88e58d38702cff7031dd47c9cdebb8503da5c9887470c2d5407a48dd507/reportlab-4.2.2.tar.gz
...
%prep
%setup -q -n reportlab-4.2.2
cd %{_builddir}/reportlab-4.2.2
pushd ..
cp -a reportlab-4.2.2 buildavx2
popd
pushd ..
cp -a reportlab-4.2.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719330564
