...
Version  : 4.1.0
Release  : 108
URL      : https://files.pythonhosted.org/packages/bc/5c/ca4381f77af19be120173c53a398d7fb78940c79eca73af4816f3307d870/reportlab-4.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/bc/5c/ca4381f77af19be120173c53a398d7fb78940c79eca73af4816f3307d870/reportlab-4.1.0.tar.gz
...
%prep
%setup -q -n reportlab-4.1.0
cd %{_builddir}/reportlab-4.1.0
pushd ..
cp -a reportlab-4.1.0 buildavx2
popd
pushd ..
cp -a reportlab-4.1.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707499763
