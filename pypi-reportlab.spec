...
Source0  : https://files.pythonhosted.org/packages/53/2f/a445108d4386ea996da5d808231a72f7e8ef353a4df7f486aa3d39883130/reportlab-3.6.7.tar.gz
...
%prep
%setup -q -n reportlab-3.6.7
cd %{_builddir}/reportlab-3.6.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645214990
...
cp %{_builddir}/reportlab-3.6.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.6.7/src/reportlab/fonts/bitstream-vera-license.txt %{buildroot}/usr/share/package-licenses/pypi-reportlab/b3245f6ac784e19a10843831b45b5944c62e3ccc
cp %{_builddir}/reportlab-3.6.7/src/reportlab/license.txt %{buildroot}/usr/share/package-licenses/pypi-reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.6.7/src/rl_addons/renderPM/libart_lgpl/COPYING %{buildroot}/usr/share/package-licenses/pypi-reportlab/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
