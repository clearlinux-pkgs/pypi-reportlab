...
Source0  : https://files.pythonhosted.org/packages/88/69/291a56d8bb177017e6e5421c34baa51b2e9017434c0ca1822e5007e45a26/reportlab-4.4.0.tar.gz
...
%prep
%setup -q -n reportlab-4.4.0
cd %{_builddir}/reportlab-4.4.0
pushd ..
cp -a reportlab-4.4.0 buildavx2
popd
pushd ..
cp -a reportlab-4.4.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745331527
