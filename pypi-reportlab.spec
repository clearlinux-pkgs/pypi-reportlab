...
Source0  : https://files.pythonhosted.org/packages/7b/d8/c3366bf10a5a5fcc3467eefa9504f6aa24fcda5817b5b147eabd37a385e1/reportlab-4.4.1.tar.gz
...
%prep
%setup -q -n reportlab-4.4.1
cd %{_builddir}/reportlab-4.4.1
pushd ..
cp -a reportlab-4.4.1 buildavx2
popd
pushd ..
cp -a reportlab-4.4.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747334891
