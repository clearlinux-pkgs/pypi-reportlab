...
Version  : 4.0.9
Release  : 107
URL      : https://files.pythonhosted.org/packages/ea/ca/06569262064a964fc4c47acfcf10143c2d814cfeb814ccaa8f4228bf6108/reportlab-4.0.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/ea/ca/06569262064a964fc4c47acfcf10143c2d814cfeb814ccaa8f4228bf6108/reportlab-4.0.9.tar.gz
...
%prep
%setup -q -n reportlab-4.0.9
cd %{_builddir}/reportlab-4.0.9
pushd ..
cp -a reportlab-4.0.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704902867
