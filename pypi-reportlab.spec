...
Version  : 4.4.2
Release  : 120
URL      : https://files.pythonhosted.org/packages/ec/9b/3483c7e4ad33d15f22d528872439e5bc92485814d7e7d10dbc3130368a83/reportlab-4.4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/ec/9b/3483c7e4ad33d15f22d528872439e5bc92485814d7e7d10dbc3130368a83/reportlab-4.4.2.tar.gz
...
%prep
%setup -q -n reportlab-4.4.2
cd %{_builddir}/reportlab-4.4.2
pushd ..
cp -a reportlab-4.4.2 buildavx2
popd
pushd ..
cp -a reportlab-4.4.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750436470
