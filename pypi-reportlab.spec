...
Version  : 4.3.0
Release  : 114
URL      : https://files.pythonhosted.org/packages/a7/f9/58a86077922bf2ad7448569e8c54721c722f91ad108d59aba2cbb6fb2d23/reportlab-4.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a7/f9/58a86077922bf2ad7448569e8c54721c722f91ad108d59aba2cbb6fb2d23/reportlab-4.3.0.tar.gz
...
%prep
%setup -q -n reportlab-4.3.0
cd %{_builddir}/reportlab-4.3.0
pushd ..
cp -a reportlab-4.3.0 buildavx2
popd
pushd ..
cp -a reportlab-4.3.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738595762
